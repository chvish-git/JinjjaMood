/*
  ...
  1. New Tables
    ...
    - `mood_logs`
      ...
      - `mood` (text)
      - `mood_type` (enum: positive, neutral, negative, bonus)
      - `journal_entry` (text)
      - `timestamp` (timestamptz)
      - `day` (text, for efficient date queries)
      - `hour` (integer, 0-23)
      - `created_at` (timestamp)
  ...
  2. Security
    ...
    - Add policies for mood logs with proper validation

  3. Indexes
    - Add indexes for efficient querying by user_id, day, and timestamp
*/
